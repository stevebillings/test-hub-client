...
public class JiraTicket {
	...
	public JiraTicket(Date dateCreated, JiraTicketType ticketType, String projectName, String projectVersionName,
			String componentName, String componentVersionName, String vulnerabilityName, String ruleName,
	...
	public String toString() {
		return "JiraTicket [dateCreated=" + dateCreated + ", ticketType=" + ticketType + ", projectName=" + projectName
				+ ", projectVersionName=" + projectVersionName + ", componentName=" + componentName
				+ ", componentVersionName=" + componentVersionName + ", vulnerabilityName=" + vulnerabilityName
				+ ", ruleName=" + ruleName + ", actionRequired=" + actionRequired + "]";
	}
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((actionRequired == null) ? 0 : actionRequired.hashCode());
		result = prime * result + ((componentName == null) ? 0 : componentName.hashCode());
		result = prime * result + ((componentVersionName == null) ? 0 : componentVersionName.hashCode());
		...
		result = prime * result + ((vulnerabilityName == null) ? 0 : vulnerabilityName.hashCode());
		return result;
	}
