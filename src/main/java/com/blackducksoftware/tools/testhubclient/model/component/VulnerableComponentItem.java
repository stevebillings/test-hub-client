...
public class VulnerableComponentItem {
	...
	public String toString() {
		return "VulnerableComponentItem [componentVersionLink=" + componentVersionLink + ", componentName="
				+ componentName + ", componentVersionName=" + componentVersionName + ", vulnerabilityWithRemediation="
