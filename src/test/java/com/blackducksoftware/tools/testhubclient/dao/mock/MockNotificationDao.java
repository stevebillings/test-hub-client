...
public class MockNotificationDao implements NotificationDao {
	...
	public <T> T getFromRelativeUrl(Class<T> modelClass, List<String> urlSegments,
		...
		if (modelClass == HubItemList.class) {
			...
			MetaInformation meta = new MetaInformation(null, TEST_ITEM_URL, null);
			notif.setMeta(meta);
			...
			throw new UnsupportedOperationException("getFromRelativeUrl() not implemented for class "
					+ modelClass.getName());
		}
	}
	...
	public <T> T getFromAbsoluteUrl(Class<T> modelClass, String url) throws NotificationDaoException {
		throw new UnsupportedOperationException("getFromAbsoluteUrl() not implemented");
	}
